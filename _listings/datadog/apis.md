...
- name: DataDog Merged API - Delete Downtime Downtime
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downtime/master/_listings/datadog/downtimedowntime-id-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downtime/master/_listings/datadog/downtimedowntime-id-delete-openapi.md
- name: DataDog Merged API - Get Downtime Downtime
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downtime/master/_listings/datadog/downtimedowntime-id-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downtime/master/_listings/datadog/downtimedowntime-id-get-openapi.md
- name: DataDog Merged API - Get Downtime
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downtime/master/_listings/datadog/downtime-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/downtime/master/_listings/datadog/downtime-get-openapi.md
x-common:
- type: x-api-gallery
